    ...
    certificates: [
        {
            ...
            issuer: 'FreeCodeCamp',
            verifyUrl: 'https://freecodecamp.org/certification/mxolisibhotile/responsive-web-design'
        },
        {
            image: '/assets/cert/Javascript Algorithms and Data Structures.png',
            issuer: 'FreeCodeCamp',
            verifyUrl: 'https://freecodecamp.org/certification/mxolisibhotile/javascript-algorithms-and-data-structures-v8'
        },
        {
            image: '/assets/cert/Front End Development Libraries.png',
            issuer: 'FreeCodeCamp',
            verifyUrl: 'https://freecodecamp.org/certification/mxolisibhotile/front-end-development-libraries'
        },
        {
        ...
        //     verifyUrl: 'https://academy.appoftheyear.co.za/'
        // }
    ]
};
