        ...
        if (project.isVideo) {
            ...
            return `
                <img src="${project.display}" alt="${project.title}" 
                     ...
                     onerror="this.src='/public/assets/works/muriel_prototype.png'; this.classList.add('loaded')"
...
const projects = [
    ...
    },
    {
        ...
        live_site: "https://levii17.github.io/constructionClientPortal/",
        figma_design: "",
        github: "https://github.com/Levii17/constructionClientPortal",
        display: "/assets/works/client_portal.mp4",
        isVideo: true
    },
    {
        year: "2025",
